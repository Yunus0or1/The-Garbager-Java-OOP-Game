 ...
 * @author Yunus
 */
public class Dustbin_2 extends StaticEntity {

    public Dustbin_2(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.dustbin_2, (int) (x - handler.getGameCamera().getxOffset()), 
